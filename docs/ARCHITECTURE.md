...
- Launch gate (Batch 4 — Launch Readiness): k6 load test on dispatch flow — e.g., 50 orders/min sustained, offer delivery p95 <3 s, Emergency ETA SLO instrumented.
...
| **Batch 2 — Trust, Safety & Marketplace Growth** | TBD | Trust tiers, verification improvements, penalty engine, Handly Guarantee, cashback, referrals, master subscriptions, master analytics | TBD |
| **Batch 3 — Operations & Scale** | TBD | Admin dashboard, analytics, support tools, performance optimization, beta preparation | TBD |
| **Batch 4 — Launch Readiness** | TBD | Infrastructure, monitoring, CI/CD, backups, security hardening, production deployment | TBD |
...
> **Roadmap correction (2026-07-21) — this is now the source of truth, do not reinterpret milestone/batch numbers from any earlier version of this table:** M0–M5 above are as actually built. Everything after M5 is organized as founder-defined **batches**, not further M-numbers: **Batch 2 — Trust, Safety & Marketplace Growth** (trust tiers, verification improvements, penalty engine, Handly Guarantee, cashback, referrals, master subscriptions, master analytics); **Batch 3 — Operations & Scale** (admin dashboard, analytics, support tools, performance optimization, beta preparation); **Batch 4 — Launch Readiness** (infrastructure, monitoring, CI/CD, backups, security hardening, production deployment). This superseded an earlier version of this table (original M4 "Money", M5 "Trust & incentives", M6 "Admin dashboard", M7 "Hardening & beta") that did not match what the founder actually meant by those numbers once M4/M5 were redefined as Job Execution / Payments.
